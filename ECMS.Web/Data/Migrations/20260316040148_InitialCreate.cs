        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ClassName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_ScheduleId_StudentId",
                table: "Attendances",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Scores_StudentId_ClassId_ScoreTypeId",
                table: "Scores",
                columns: new[] { "StudentId", "ClassId", "ScoreTypeId" },
                unique: true);
